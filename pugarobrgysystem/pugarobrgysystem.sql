...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2024 at 11:13 AM
...
CREATE TABLE `blotters` (
  ...
  `status` varchar(100) NOT NULL DEFAULT 'O',
...
INSERT INTO `blotters` (`id`, `incident_type`, `date_time_reported`, `date_time_incident`, `reporter_name`, `reporter_birthdate`, `reporter_civil_status`, `reporter_gender`, `reporter_religion`, `reporter_address`, `defendant_name`, `defendant_birthdate`, `defendant_civil_status`, `defendant_gender`, `defendant_religion`, `defendant_address`, `ref`, `status`, `narrative`, `created_at`, `updated_at`) VALUES
(3, 'wala ', '2024-11-30 22:43:00', '2024-11-30 22:43:00', 'adafsdf', '2024-11-02', 'Single', 'Male', 'dfsdf', 'zone 1', 'zxvxcvxvx', '2024-11-01', 'Married', 'Male', 'INC', 'Purok 4', '674b24c788797', 'O', 'This is narrative report', '2024-11-30 14:44:23', '2024-11-30 14:44:55');
...
(3, '11', 'sample feedback', '2024-11-27 20:30:06', '2024-11-27 20:30:06');
...
(19, '1267470fba3df4a', 'Barangay Clearance', 'work', 'sampl', 'Cruz', 'Dela Cruz', '2024-11-27', 20, 'Pugaro Manaoag Pangasinan', '2024-11-27 20:25:30', '2024-11-27 20:27:35', 'Cancelled', 11);
...
(33, '11', 'sample forum', '2024-11-27 20:35:51', '2024-11-27 20:35:51');
...
INSERT INTO `resident` (`id`, `name`, `bdate`, `civilstatus`, `religion`, `gender`, `address`, `created_at`, `updated_at`) VALUES
(6, 'Juana Dela Cruzes', '2024-11-01', 'single', 'INC', 'Female', 'MANAOAG Pangasinan', '2024-07-11 21:48:42', '2024-11-30 22:42:19'),
(12, 'Sun Kissed Lola', '2024-11-30', 'married', 'INC', 'Male', 'TAGA DOON', '2024-11-30 22:25:28', '2024-11-30 22:25:28');
...
(13, 'sample ', 'ko', 'Lang', 'Male', '2024-12-01', 'Pugaro Manaoag Pangasinan', '09123456789', 'jonelnagtalon@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '294695', 0, NULL, NULL, NULL),
(14, 'sample ', 'ko', 'Lang', 'Female', '2024-12-01', 'Pugaro Manaoag Pangasinan', '09123456789', 'joharirebualos@gmail.com', '202cb962ac59075b964b07152d234b70', '949681', 0, NULL, NULL, NULL);
...
--
ALTER TABLE `forms`
  MODIFY `form_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
